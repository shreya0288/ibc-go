...
// MsgDeregisterInterchainAccount defines the payload for Msg/DeregisterAccount
type MsgDeregisterInterchainAccount struct {
	Owner        string `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner,omitempty"`
	ConnectionId string `protobuf:"bytes,2,opt,name=connection_id,json=connectionId,proto3" json:"connection_id,omitempty"`
}

func (m *MsgDeregisterInterchainAccount) Reset()         { *m = MsgDeregisterInterchainAccount{} }
func (m *MsgDeregisterInterchainAccount) String() string { return proto.CompactTextString(m) }
func (*MsgDeregisterInterchainAccount) ProtoMessage()    {}
func (*MsgDeregisterInterchainAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_7def041328c84a30, []int{6}
}
func (m *MsgDeregisterInterchainAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgDeregisterInterchainAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgDeregisterInterchainAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgDeregisterInterchainAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgDeregisterInterchainAccount.Merge(m, src)
}
func (m *MsgDeregisterInterchainAccount) XXX_Size() int {
	return m.Size()
}
func (m *MsgDeregisterInterchainAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgDeregisterInterchainAccount.DiscardUnknown(m)
}

var xxx_messageInfo_MsgDeregisterInterchainAccount proto.InternalMessageInfo

// MsgDeregisterInterchainAccountResponse defines the response for Msg/DeregisterAccount
type MsgDeregisterInterchainAccountResponse struct {
	ChannelId string `protobuf:"bytes,1,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	PortId    string `protobuf:"bytes,2,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
}

func (m *MsgDeregisterInterchainAccountResponse) Reset() {
	*m = MsgDeregisterInterchainAccountResponse{}
}
func (m *MsgDeregisterInterchainAccountResponse) String() string { return proto.CompactTextString(m) }
func (*MsgDeregisterInterchainAccountResponse) ProtoMessage()    {}
func (*MsgDeregisterInterchainAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7def041328c84a30, []int{7}
}
func (m *MsgDeregisterInterchainAccountResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgDeregisterInterchainAccountResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgDeregisterInterchainAccountResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgDeregisterInterchainAccountResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgDeregisterInterchainAccountResponse.Merge(m, src)
}
func (m *MsgDeregisterInterchainAccountResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgDeregisterInterchainAccountResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgDeregisterInterchainAccountResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgDeregisterInterchainAccountResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgDeregisterInterchainAccount)(nil), "ibc.applications.interchain_accounts.controller.v1.MsgDeregisterInterchainAccount")
	proto.RegisterType((*MsgDeregisterInterchainAccountResponse)(nil), "ibc.applications.interchain_accounts.controller.v1.MsgDeregisterInterchainAccountResponse")
}
...
var fileDescriptor_7def041328c84a30 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	DeregisterInterchainAccount(ctx context.Context, in *MsgDeregisterInterchainAccount, opts ...grpc.CallOption) (*MsgDeregisterInterchainAccountResponse, error)
}
...
func (c *msgClient) DeregisterInterchainAccount(ctx context.Context, in *MsgDeregisterInterchainAccount, opts ...grpc.CallOption) (*MsgDeregisterInterchainAccountResponse, error) {
	out := new(MsgDeregisterInterchainAccountResponse)
	err := c.cc.Invoke(ctx, "/ibc.applications.interchain_accounts.controller.v1.Msg/DeregisterInterchainAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// DeregisterInterchainAccount defines a rpc handler for MsgDeregisterInterchainAccount.
	DeregisterInterchainAccount(context.Context, *MsgDeregisterInterchainAccount) (*MsgDeregisterInterchainAccountResponse, error)
}
...
func (*UnimplementedMsgServer) DeregisterInterchainAccount(ctx context.Context, req *MsgDeregisterInterchainAccount) (*MsgDeregisterInterchainAccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeregisterInterchainAccount not implemented")
}
...
func _Msg_DeregisterInterchainAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgDeregisterInterchainAccount)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).DeregisterInterchainAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ibc.applications.interchain_accounts.controller.v1.Msg/DeregisterInterchainAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).DeregisterInterchainAccount(ctx, req.(*MsgDeregisterInterchainAccount))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeregisterInterchainAccount",
			Handler:    _Msg_DeregisterInterchainAccount_Handler,
		},
	},
...
func (m *MsgDeregisterInterchainAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgDeregisterInterchainAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDeregisterInterchainAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgDeregisterInterchainAccountResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgDeregisterInterchainAccountResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDeregisterInterchainAccountResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgDeregisterInterchainAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDeregisterInterchainAccountResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDeregisterInterchainAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgDeregisterInterchainAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgDeregisterInterchainAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgDeregisterInterchainAccountResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgDeregisterInterchainAccountResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgDeregisterInterchainAccountResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
