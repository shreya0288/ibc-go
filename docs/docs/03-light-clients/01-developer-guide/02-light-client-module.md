...
Learn how to implement the [`LightClientModule`](https://github.com/cosmos/ibc-go/blob/650d7853263596e7dfe671c332029eab9d97a725/modules/core/exported/client.go#L51-L133) interface. This list of methods described here does not include all methods of the interface. Some methods are explained in detail in the relevant sections of the guide.
